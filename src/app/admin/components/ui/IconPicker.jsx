...
export default function IconPicker({
  ...
  const { data: icons, loading } = useFirestoreCollection("icons", "name");
  const [isOpen, setIsOpen] = useState(false);
  const [search, setSearch] = useState("");

  const currentIcon = selectedIconId
    ? icons.find((i) => i.id === selectedIconId || i.id === selectedIconId.toLowerCase()) || null
    : null;
